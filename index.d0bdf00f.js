...
parcelRequire.register("lmpGf", function(module, exports) {

module.exports = import("./" + (parcelRequire("2JpsI")).resolve("8ito0")).then(()=>parcelRequire('49pUz')
);

});

parcelRequire.register("hbZhh", function(module, exports) {


module.exports = Promise.all([
    import("./" + (parcelRequire("2JpsI")).resolve("8ito0")),
    import("./" + (parcelRequire("2JpsI")).resolve("8JPWu"))
]).then(()=>parcelRequire('9gwv8')
);

});

parcelRequire.register("5xVtp", function(module, exports) {


module.exports = Promise.all([
    import("./" + (parcelRequire("2JpsI")).resolve("8ito0")),
    import("./" + (parcelRequire("2JpsI")).resolve("1QdcW"))
]).then(()=>parcelRequire('776mU')
);

});

var $1b33dcf5c286c30f$exports = {};

(parcelRequire("2JpsI")).register(JSON.parse("{\"amH9b\":\"index.d0bdf00f.js\",\"8ito0\":\"three.module.6ca5a366.js\",\"8JPWu\":\"GLTFLoader.794bfc62.js\",\"1QdcW\":\"OrbitControls.d3c05f23.js\"}"));
...
customElements.define('three-renderer', class extends HTMLElement {
    ...
    async connectedCallback() {
        const THREE = await (parcelRequire("lmpGf"));
...
customElements.define('three-scene-ecssh', class extends HTMLElement {
    ...
    async loadGLTF(url) {
        const GLTFLoaderModule = await (parcelRequire("hbZhh"));
...
customElements.define('three-orbitcontroller', class extends HTMLElement {
    async connectedCallback() {
        const OrbitControlsModule = await (parcelRequire("5xVtp"));
